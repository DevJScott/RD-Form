...
function SubStep7ScienceArea({ formData, onChange }) {
    ...
    <div style={{ marginBottom: "20px" }}>
      ...
      {otherKey && (
        <label style={{ display: "block", marginTop: "8px" }}>
          ...
          <input
            type="text"
            value={(formData.scienceAreasOther && formData.scienceAreasOther[otherKey]) || ""}
  ...
  return (
    <div>
      ...
      <p>
        To qualify for tax relief, the difficulties must be related to a scientific or technological field. Please
        select up to 3 areas in which <strong>{formData.companyName || "PLAYCRAFT LTD"}</strong> worked.
      </p>
