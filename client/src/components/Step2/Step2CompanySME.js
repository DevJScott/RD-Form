    ...
    <div className="step-wrapper">
      ...
      <div className="section-card">
        ...
        {totalStaff < 4 && (
          <p style={{ color: "orange" }}>
            Note: Fewer than 4 staff may make this commercially unviable, though
      ...
      <div className="section-card">
        ...
        {formData.partOfGroup === "Yes" && (
          <>
            <label>Total employees in the group:</label>
            <br />
            <input
              type="number"
              value={formData.groupTotalEmployees || ""}
              onChange={(e) => onChange("groupTotalEmployees", e.target.value)}
            />
            <br />
            <br />

            <label>Group total revenue (£):</label>
            <br />
            <input
              type="number"
            ...
            <label>Group total expenditure (£):</label>
            <br />
            <input
              type="number"
